...
function library:Evil(text,text2,logo)
	...
	UIGradient50.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30,30,30)), ColorSequenceKeypoint.new(0.29, Color3.fromRGB(30, 30, 30)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(30, 30, 30)), ColorSequenceKeypoint.new(0.68, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,0,0))}
	UIGradient50.Parent = Main
	...
	Logo.Size = UDim2.new(0, 585, 0, 400)
	Logo.ImageTransparency = 0.3
	Logo.Image = "rbxassetid://"

	local Title_UiStroke1 = Instance.new("UIStroke")

	Title_UiStroke1.Color = Color3.fromRGB(255,25,25)
	Title_UiStroke1.Thickness = 2
	Title_UiStroke1.Name = "Title_UiStroke1"
	Title_UiStroke1.Parent = Logo

	local UIGradient2 = Instance.new("UIGradient")
	UIGradient2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30,30,30)), ColorSequenceKeypoint.new(0.29, Color3.fromRGB(60,60,60)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(12,13,14)), ColorSequenceKeypoint.new(0.68, Color3.fromRGB(60, 60, 60)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30,30,30))}
	UIGradient2.Parent = Title_UiStroke1
	...
	Welcome.Position = UDim2.new(0, 355, 0, 10)
	Welcome.Size = UDim2.new(0, 483, 0, 31)
	...
	spawn(function()
		while wait() do
			Welcome.Text = "W" wait(1) Welcome.Text = "We" wait(1) Welcome.Text = "Wel" wait(1) Welcome.Text = "Welc" wait(1) Welcome.Text = "Welco" wait(1) Welcome.Text = "Welcom" wait(1) Welcome.Text = "Welcome" wait(1) Welcome.Text = "Welcome T" wait(1) Welcome.Text = "Welcome To" wait(1) Welcome.Text = "Welcome To J" wait(1) Welcome.Text = "Welcome To Ja" wait(1) Welcome.Text = "Welcome To Java"  wait(1) Welcome.Text = "Welcome To Java H" wait(1) Welcome.Text = "Welcome To Java Hu" wait(1) Welcome.Text = "Welcome To Java Hub" wait(5) Welcome.Text = "" 
		end
	end)
	...
	spawn(function()
		while wait() do
			if _G.RunDis then
				...
				mainDiscord.Rotation = 0
			end
		end
	end)

	mainDiscord.MouseButton1Click:Connect(function()
		setclipboard("https://discord.gg/uDPzRDgqN8")
		wait(.1)
	...
	local UIMakeBy = Instance.new("TextLabel")
	UIMakeBy.Name = "UIMakeBy"
	UIMakeBy.Parent = Main
	UIMakeBy.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	UIMakeBy.BackgroundTransparency = 1.000
	UIMakeBy.Position = UDim2.new(0, 425, 0, 377)
	UIMakeBy.Size = UDim2.new(0, 483, 0, 31)
	UIMakeBy.Font = Enum.Font.GothamMedium
	UIMakeBy.Text = "UI Edit By : Ares.#4173"
	UIMakeBy.TextColor3 = Color3.fromRGB(255, 0, 0)
	UIMakeBy.TextSize = 12.000
	UIMakeBy.TextWrapped = true
	UIMakeBy.TextXAlignment = Enum.TextXAlignment.Left
	...
	Top.Position = UDim2.new(0.021956088, 0, 0.0133333337, 35)
	...
	TabHolder.Size = UDim2.new(0, 565, 0, 38)
	...
	TabContainer.Size = UDim2.new(0, 565, 0, 38)
	...
	Bottom.Position = UDim2.new(0.0119760484, 7, 0, 85)
	...
	function tabs:CraftTab(Name,icon)
		...
		FrameTab.Parent = Tab
		--FrameTab.BackgroundColor3 = Color3.fromRGB(60, 61, 62)
		FrameTab.BackgroundTransparency = 0.7
		FrameTab.Size = UDim2.new(0, 140, 0, 30)

		local UIGradient555 = Instance.new("UIGradient")
		UIGradient555.Rotation = 90
		UIGradient555.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30,30,30)), ColorSequenceKeypoint.new(0.29, Color3.fromRGB(30, 30, 30)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(30, 30, 30)), ColorSequenceKeypoint.new(0.68, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0,0,0))}
		UIGradient555.Parent = FrameTab

		local UIStroke956 = Instance.new("UIStroke")
		UIStroke956.Thickness = 1.2
		UIStroke956.Parent = FrameTab
		UIStroke956.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
		UIStroke956.LineJoinMode = Enum.LineJoinMode.Round
		UIStroke956.Color = _G.Color
		UIStroke956.Transparency = 0.10
		...
		Page.Size = UDim2.new(0, 600, 0, 300)
		...
		Left.Size = UDim2.new(0, 274, 0, 300)
		...
		Right.Size = UDim2.new(0, 274, 0, 300)
		...
		function sections:CraftPage(Name,side)
			...
			function functionitem:Label(text)
				...
				Label.Size = UDim2.new(0, 274, 0, 30)
			...
			function functionitem:Toggle(Name, default, callback)
				...
				MainToggle.Size = UDim2.new(0, 265, 0, 35)
			...
			function functionitem:Textbox(Name, Placeholder, callback)
				...
				ButtonColor44.Transparency = 0.8
			...
			function functionitem:Dropdown(Name, list, default, callback)
				...
				MainDropDown.BackgroundColor3 = Color3.fromRGB(22, 22, 22)
				...
				MainDropDown_2.BackgroundColor3 = Color3.fromRGB(22, 22, 22)
				...
				function Dropfunc:TogglePanel(state)
					TweenService:Create(
						MainDropDown,
						TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{Size = state and UDim2.new(0, 265, 0, 299) or UDim2.new(0, 265, 0, 30)}
					):Play()
					TweenService:Create(
						ImageButton,
						TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function functionitem:MultiDropdown(Name, list, default, callback)
				...
				function Dropfunc:TogglePanel(state)
					TweenService:Create(
						MainDropDown,
						TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{Size = state and UDim2.new(0, 265, 0, 200) or UDim2.new(0, 265, 0, 30)}
					):Play()
					TweenService:Create(
						ImageButton,
						TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function functionitem:Slider(text,floor,min,max,de,callback)
				...
				SliderFrame.Size = UDim2.new(0, 265, 0, 35)
				...
				PartValue.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
...
ImageButton.Image = "http://www.roblox.com/asset/?id="..(15832807266)
